    ...
    "ProInfos": [
        {
            ...
            // 质押金额
            "PledgeMoney": "314.57 Token",
            "PledgeTime": "2020-05-27 Wed 13:05:49 CST"
        },
        ...
    ]
```
...
{
    // 用户地址
    "UserAddr": "0x46EF41A6c60912173b50dAD714Ca2a6f82c32aE8",
    // 用户余额
    "Balance": 1999996774493642600,
    "Balance": "1.04 Token",
    // query合约地址
    "QueryAddr": "0xdDE451A637676134d6c58E0aE91Dab3B51297422",
    // upkeeping信息
    "UpkeepingInfo": {
        // 合约地址
        "UpKeepingAddr": "0x321aaC1C2d9DBc003e2d4677A1C5e74930cA5374",
        // 余额
        "UkBalance": "95.69 Token",
        // 需要支付
        "NeedPay": "1.26 Token",
        // 开始时间
        "StartTime": "2020-05-25 Mon 16:08:48 CST",
        // 结束时间
    ...
    "ProviderInfos": [
        {
            // channel合约地址，用于读支付
            "ProviderAddr": "0x22cEB127ae1C15fc6DbAE855cD99fdaf907bC0ba",
            "ChannelAddr": "0xa9E09a98d81b135636Cb5445050d85983e75B720",
            "StartTime": "2020-05-25 Mon 16:13:24 CST",
            "Duration": "1000 day",
            // 合约余额
            "Money": "32000.00 Gwei",
            // 合约已使用
